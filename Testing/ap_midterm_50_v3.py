...
# Quiz Data: 50 Questions including your revised Question 1
quiz_data = [
...
<head>
    ...
    <style>
        ...
        .card { background: #fff; border: 2px solid #3498db; border-radius: 15px; padding: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); margin-bottom: 20px; }
        ...
        .secondary-btn { background: #95a5a6 !important; width: 30% !important; display: inline-block !important; margin: 5px; }
...
<body>
    <div class="container">
        ...
        <div id="quiz-section">
            ...
            <button id="restart-btn" style="display:none; background:#27ae60;" onclick="startQuiz()">Reshuffle & Restart Quiz</button>
        ...
        <div id="flashcard-container">
            <div class="card">
                ...
                <button onclick="toggleCardAnswer()" style="background: #e67e22; width: auto; margin: auto; padding: 10px 20px;">Show / Hide Answer</button>
    ...
    <script>
        ...
        function nextCard() { currentCardIndex = (currentCardIndex + 1) % activeCards.length; updateFlashcard(); }
        function prevCard() { currentCardIndex = (currentCardIndex - 1 + activeCards.length) % activeCards.length; updateFlashcard(); }
        startQuiz();
    </script>
</body>
</html>
...
file_path = "ap_study_tool_fixed.html"
with open(file_path, "w", encoding="utf-8") as f:
    f.write(final_html)

webbrowser.open("file://" + os.path.abspath(file_path))
print(f"Success! Study Suite opened from: {file_path}")