...
[Image of a neuron with labeled parts]
        ...
        <button onclick="checkAnswers()">Submit and Grade My Test</button>
        <div id="score-box"></div>
    </div>

    <script>
        const data = {json.dumps(quiz_data)};
        ...
        function checkAnswers() {{
            ...
            data.forEach((q, i) => {{
                ...
                const options = document.querySelectorAll(`#block-${{i}} .opt`);
...
file_name = "midterm_prep.html"
with open(file_name, "w", encoding="utf-8") as f:
    f.write(html_content)

webbrowser.open("file://" + os.path.abspath(file_name))
print("Quiz generated! Check your browser.")